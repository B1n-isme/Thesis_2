...
from src.models.neuralforecast.auto_cfg import get_bitcoin_optimized_configs, get_bitcoin_optimized_configs_legacy

torch.set_float32_matmul_precision('high')


def get_auto_models(h: int, loss_fn=None, num_samples: int = 10,
    ...
    # Bitcoin-optimized configuration ranges
    configs = get_bitcoin_optimized_configs(h)
