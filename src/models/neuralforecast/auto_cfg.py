...
def get_bitcoin_optimized_configs(h: int) -> Dict[str, Dict]:
    """
...
def get_bitcoin_optimized_configs_legacy(h: int) -> Dict[str, Dict]:
    """
    ...
    nhits_config = {
        'input_size': tune.choice([h * 2, h * 3, h * 4, h * 6, h * 8]),  # Longer lookback for crypto
        ...
        'stack_types': tune.choice([['identity', 'identity'], ['trend', 'seasonality']]),
